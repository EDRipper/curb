export function CurbCutIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* motion dashes trailing the wheel */}
      <line x1="35" y1="120" x2="55" y2="120" stroke="#d4d4d8" strokeWidth="3" strokeLinecap="round" />
      <line x1="60" y1="120" x2="75" y2="120" stroke="#d4d4d8" strokeWidth="3" strokeLinecap="round" />
      <line x1="80" y1="120" x2="90" y2="120" stroke="#d4d4d8" strokeWidth="3" strokeLinecap="round" />

      {/* wheelchair: wheel, frame, small rider head */}
